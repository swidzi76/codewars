...
public class main {
    private static PokerHand.Result loss = PokerHand.Result.LOSS;
    private static PokerHand.Result win = PokerHand.Result.WIN;
    private static PokerHand.Result tie = PokerHand.Result.TIE;
    ...
    public static void main(String[] args) {
        ...
        Test("Equal cards is tie",      win,  "JH AH TH KH QH", "7C 7S 3S 7H 5S");

    }
    public static void Test(String description, PokerHand.Result expected, String playerHand, String opponentHand){
        ...
        System.out.println(description + " : "+expected + " RESULT : " + result);
